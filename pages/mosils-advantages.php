...
<section class="relative h-[500px] flex items-center justify-center overflow-hidden bg-black">
    <div class="absolute inset-0 z-0">
        <img src="<?php echo SITE_URL; ?>/assets/images/ui/high-performance.png"
            ...
            onerror="this.src='https://placehold.co/1920x600/1A3B1B/FFFFFF?text=Advantages'">
    </div>
    <div class="container relative z-10 text-center text-white">
        <h1 class="text-4xl md:text-6xl font-bold mb-4">Why Choose MOSIL?</h1>
        <p class="text-lg md:text-xl max-w-3xl mx-auto opacity-90">
            Decades of expertise, cutting-edge infrastructure, and a customer-centric approach that drives performance.
        </p>
    </div>
</section>
...
<section class="py-0 bg-[#F5F5F5]">
    <div class="flex flex-col md:flex-row">
        <div class="w-full md:w-1/2 h-[400px] md:h-auto overflow-hidden">
            <img src="<?php echo SITE_URL; ?>/assets/images/ui/resreach-development.png"
