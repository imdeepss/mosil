                ...
                <div onclick="this.classList.toggle('active')"
                    ...
                    <div class="relative z-10 flex flex-col items-stretch h-full text-white">
                        ...
                        <div class="relative overflow-hidden w-full h-full">
                            <h6
                                class="relative z-10 px-6 py-4 font-bold text-lg md:text-[20px] leading-[150%] tracking-[0.01em] group-hover:text-primary [.active_&]:text-primary transition-colors duration-500 capitalize">
                ...
                foreach ($brands as $brand) {
                    ...
                    <div class="swiper-slide !w-auto">
                        <div
                            ...
                            <img decoding="async" src="<?php echo SITE_URL; ?>/assets/images/brand/<?php echo $webpName; ?>"
