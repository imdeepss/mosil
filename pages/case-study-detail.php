...
<style>
/* Standardize WYSIWYG List Styling */
.blog-content ul {
...
.blog-content ul li::before {
    ...
    box-shadow: 0 0 0 2px rgba(244, 195, 0, 0.2) !important;
}
/* Address inline styles from MS Word pasting */
    ...
    <div class="container">
        ...
        <div class="max-w-none">
            ...
            <p class="not-prose text-[#575A56] font-normal text-[16px] leading-[135%] tracking-[0.01em] mb-4">
                <?php echo formatDateWithCurrentYear($caseStudy['created_at'], 'F d'); ?>
            </p>
