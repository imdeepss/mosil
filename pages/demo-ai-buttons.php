                ...
                <div class="flex flex-wrap gap-3 relative z-10">
                    ...
                    foreach ($trending as $tag):
                        ...
                        <button onclick="triggerChatbase('<?= htmlspecialchars($tag, ENT_QUOTES) ?>')"
                            class="px-5 py-2.5 bg-white border border-gray-200 rounded-full text-[13.5px] text-slate-600 font-medium hover:bg-main-green hover:text-primary hover:border-main-green hover:shadow-[0_5px_15px_rgba(26,59,27,0.2)] transition-all duration-300 ease-out shadow-sm active:scale-95 transform hover:-translate-y-0.5">
                            <?= $tag ?>
                        </button>
                    <?php endforeach; ?>
                </div>
