...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($slug)) {
        ...
        $checkSlugSql = "SELECT id FROM event_posts WHERE slug = ?";
    ...
    if (empty($errors)) {
        try {
            ...
            $insertSql = "INSERT INTO event_posts (title, slug, short_description, content, image, category_id, tags, status, meta_title, meta_description, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <form id="NewsPostForm" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
