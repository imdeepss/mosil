    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form method="post" action="#" class="needs-validation" enctype="multipart/form-data"
                id="editProductForm<?php echo $id; ?>">
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="productTab<?php echo $id; ?>" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="basic-tab<?php echo $id; ?>" data-bs-toggle="tab"
                                data-bs-target="#basic<?php echo $id; ?>" type="button" role="tab"
                                aria-controls="basic<?php echo $id; ?>" aria-selected="true">Basic Information</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="categories-tab<?php echo $id; ?>" data-bs-toggle="tab"
                                data-bs-target="#categories<?php echo $id; ?>" type="button" role="tab"
                                aria-controls="categories<?php echo $id; ?>" aria-selected="false">Categories</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="attributes-tab<?php echo $id; ?>" data-bs-toggle="tab"
                                data-bs-target="#attributes<?php echo $id; ?>" type="button" role="tab"
                                aria-controls="attributes<?php echo $id; ?>" aria-selected="false">Attributes</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="details-tab<?php echo $id; ?>" data-bs-toggle="tab"
                                data-bs-target="#details<?php echo $id; ?>" type="button" role="tab"
                                aria-controls="details<?php echo $id; ?>" aria-selected="false">Product Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="media-tab<?php echo $id; ?>" data-bs-toggle="tab"
                                data-bs-target="#media<?php echo $id; ?>" type="button" role="tab"
                                aria-controls="media<?php echo $id; ?>" aria-selected="false">Media</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="seo-tab<?php echo $id; ?>" data-bs-toggle="tab"
                    ...
                    <div class="tab-content p-3 border border-top-0" id="productTabContent<?php echo $id; ?>">
                        ...
                        <div class="tab-pane fade show active" id="basic<?php echo $id; ?>" role="tabpanel"
                            aria-labelledby="basic-tab<?php echo $id; ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="product_name<?php echo $id; ?>" class="form-label">Product Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="product_name<?php echo $id; ?>"
                                            name="product_name" value="<?php echo htmlspecialchars($product['name']); ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="product_slug<?php echo $id; ?>" class="form-label">Product Slug <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="product_slug<?php echo $id; ?>"
                                            name="product_slug" value="<?php echo htmlspecialchars($product['slug']); ?>"
                                            required>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="sub_title<?php echo $id; ?>" name="sub_title"
                                    value="<?php echo htmlspecialchars($product['sub_title'] ?? ''); ?>"></input>
                            </div>
                            <div class="mb-3">
                                <label for="short_description<?php echo $id; ?>" class="form-label">Short
                                    Description</label>
                                <textarea class="form-control" id="short_description<?php echo $id; ?>"
                        ...
                        <!-- Categories Tab -->
                        <div class="tab-pane fade" id="categories<?php echo $id; ?>" role="tabpanel"
                            aria-labelledby="categories-tab<?php echo $id; ?>">
                            <div class="mb-3">
                                <label for="parent_cat<?php echo $id; ?>" class="form-label">Parent Category <span
                                        class="text-danger">*</span></label>
                                <select class="form-select select2" id="parent_cat<?php echo $id; ?>" name="parent_cat[]"
                                    multiple required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2" id="main_cat<?php echo $id; ?>" name="main_cat[]"
                                    multiple>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2" id="sub_cat<?php echo $id; ?>" name="sub_cat[]"
                                    multiple>
                        ...
                        <!-- Attributes Tab -->
                        <div class="tab-pane fade" id="attributes<?php echo $id; ?>" role="tabpanel"
                            aria-labelledby="attributes-tab<?php echo $id; ?>">
                            <div class="mb-3">
                                <label for="parent_attribute<?php echo $id; ?>" class="form-label">Parent Attribute</label>
                                <select class="form-select select2" id="parent_attribute<?php echo $id; ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2" id="main_attribute<?php echo $id; ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2" id="sub_attribute<?php echo $id; ?>"
                        ...
                        <!-- Product Details Tab -->
                        <div class="tab-pane fade" id="details<?php echo $id; ?>" role="tabpanel"
                            aria-labelledby="details-tab<?php echo $id; ?>">
                            <div class="mb-3">
                                <label for="packing<?php echo $id; ?>" class="form-label">Packing</label>
                                <select class="form-select select2" id="packing<?php echo $id; ?>" name="packing[]"
                                    multiple>
                            ...
                            <div class="mb-3">
                                <label for="area_of_application<?php echo $id; ?>" class="form-label">Area of
                                    Application</label>
                                <textarea class="form-control rich-editor" id="area_of_application<?php echo $id; ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control rich-editor" id="benifits<?php echo $id; ?>" name="benifits"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control rich-editor" id="characteristics<?php echo $id; ?>"
                        ...
                        <!-- Media Tab -->
                        <div class="tab-pane fade" id="media<?php echo $id; ?>" role="tabpanel"
                            aria-labelledby="media-tab<?php echo $id; ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="product_image<?php echo $id; ?>" class="form-label">Product
                                            Image</label>
                                        <?php if (!empty($product['image'])): ?>
                                            <div class="mb-2">
                                                <img src="../assets/uploads/products-image/<?php echo htmlspecialchars($product['image']); ?>"
                                                    alt="Current Product Image" class="img-thumbnail product_img"
                                                    style="max-height: 150px;">
                                            </div>
                                        <?php endif; ?>
                                        <input type="file" class="form-control required"
                                            id="product_image<?php echo $id; ?>" name="product_image" accept="image/*"
                                            required>
                                        <input type="hidden" class="existing_image"
                                            value="../assets/uploads/products-image/<?php echo htmlspecialchars($product['image']); ?>" />
                                        <div class="form-text">Leave empty to keep the current image. Accepted formats: JPG,
                                            JPEG, PNG, GIF.</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <?php if (!empty($product['tds_file'])): ?>
                                            <div class="mb-2">
                                                <a href="../assets/uploads/tds/<?php echo htmlspecialchars($product['tds_file']); ?>"
                                                    target="_blank" class="btn btn-sm btn-outline-primary">
                                                    <i class="fas fa-file-pdf me-1"></i> View Current TDS File
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                        <input type="file" class="form-control required" id="tds_file<?php echo $id; ?>"
                                            name="tds_file" accept=".pdf,.doc,.docx" required>
                                        <input type="hidden" class="existing_image"
                                            value="../assets/uploads/tds/<?php echo htmlspecialchars($product['tds_file']); ?>" />
                                        <div class="form-text">Leave empty to keep the current file. Accepted formats: PDF,
                                            DOC, DOCX.</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <!-- SEO Tab -->
                        <div class="tab-pane fade" id="seo<?php echo $id; ?>" role="tabpanel"
                            aria-labelledby="seo-tab<?php echo $id; ?>">
                            <div class="mb-3">
                                <label for="meta_title<?php echo $id; ?>" class="form-label">Meta Title</label>
                                <input type="text" class="form-control" id="meta_title<?php echo $id; ?>" name="meta_title"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="meta_description<?php echo $id; ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="meta_keywords<?php echo $id; ?>"
                                    name="meta_keywords"
